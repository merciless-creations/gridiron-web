      ...
      <section className="card animate-slide-up" style={{ animationDelay: '0.1s' }}>
        ...
        {teams && teams.length > 0 ? (
          ...
          <div className="flex flex-col items-center text-center py-6 animate-fade-in">
            ...
            <h3 className="text-lg font-medium text-gridiron-text-primary mb-2">No Teams Assigned</h3>
            <p className="text-gridiron-text-secondary mb-4 max-w-sm">
              You haven't been assigned to manage any teams yet. When a commissioner invites you to a league, your team will appear here.
            </p>
            <Link to="/leagues/create" className="btn-primary">
